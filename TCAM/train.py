...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        det_info, seg_info,score_evalute = utils.evaluate(model, val_data_loader, device=device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-path', default='./TCA', help='dataset')
    parser.add_argument('--num-classes', default=4, type=int, help='num_classes')
    parser.add_argument('--output-dir', default='./TCA', help='path where to save')
