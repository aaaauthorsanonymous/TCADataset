...
def resnet50_fpn_backbone(pretrain_path="",
    ...
    Args:
        pretrain_path: resnet50 pre-training weight, which defaults to empty if not used
        norm_layer: The default is nn.BatchNorm2d. If the GPU memory is small, the batch_size cannot be set to large.
                    It is recommended to set the norm_layer to FrozenBatchNorm2d(nn.BatchNorm2d by default).
                    (https://github.com/facebookresearch/maskrcnn-benchmark/issues/267)
        trainable_layers: Specify which layer structures to train
        returned_layers: Specify which layers of output should be returned
        extra_blocks: An additional layer structure is added on top of the output feature layer
